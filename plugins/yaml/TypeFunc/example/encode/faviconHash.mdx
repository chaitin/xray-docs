---
title: 'faviconHash'
description: '`faviconHash`函数主要是用来将字符串或 bytes 进行 faviconHash 编码，参考：[iconhash](https://github.com/Becivells/iconhash)'
---
...
> 该函数一般配合`getIconContent()`一同使用，详情参考：[🔎](/plugins/yaml/TypeFunc/example/other/getIconContent)