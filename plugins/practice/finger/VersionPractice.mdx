...
## 编写规范
版本指纹的编写规范和产品指纹的编写规范基本一致，可参考：[指纹编写规范](https://docs.xray.cool/plugins/practice/finger/Practice#prepare-a-specification)，有一点需要额外注意的是 版本检测规则尽量不要影响到产品检测规则的效果，
具体的写法可以参考示例模版1中：expression: r1() && (r2() || true) 类似这样的写法
