...
<Info>默认情况下，request中如果method为GET或者HEAD的情况下，follow_redirects选项为true，其他情况下的follow_redirects选项为false，那么就会导致发生跳转时获取的response是最终跳转页面中的内容</Info>
...
<Tip>对于这些内容，可以参考现有的poc模版相关内容，当然允许的情况下也可以是随机值</Tip>
...
[Redirect](/plugins/practice/poc/Template#ssrf-url)
